python get_vocab.py PubMed-and-PMC-w2v.bin vocab.csv # assumes you have downloaded the word embeddings
umls.db < umls.sql # merge vocab.csv with the UMLS database (assumes you have installed the UMLS database)
